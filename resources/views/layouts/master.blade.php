...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        @include('layouts.includes._sidebar')<!--pemanggilan view menu samping kiri-->   
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                @include('layouts.includes._navbar')<!--pemanggilan view menu atas-->
                ...
                <div class="container-fluid">
                        ...
                        @yield('content') <!--pemanggilan view konten-->
